...
<script type="text/javascript"
	src="${baseurl}scripts/nms-jquery-form.js"></script>
</head>
...
<body>
	<table class="submit_hint">
		...
		<tr>
			<td style="font-size: 14px;" align='center'><img alt=""
				src="${baseurl}images/yes.png" align="middle" height="30" width="30" />
				<span style="vertical-align: middle">您的操作成功！</span></td>
		</tr>
