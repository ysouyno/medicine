...
(function($) {
	...
	function _8(_9) {
		...
		if (_a.height != "auto") {
			var _15 = _d
					- _10.children("div.datagrid-header").outerHeight(true)
					- _10.children("div.datagrid-footer").outerHeight(true)
					- _b.children("div.datagrid-toolbar").outerHeight(true)
					- _b.children("div.datagrid-pager").outerHeight(true);
	...
	function _39(_3a) {
		...
		_40.find("div.datagrid-footer-inner").css("display",
				_3b.showFooter ? "block" : "none");
		_41.find("div.datagrid-footer-inner").css("display",
				_3b.showFooter ? "block" : "none");
		...
		if (_3b.toolbar) {
			...
			for (var i = 0; i < _3b.toolbar.length; i++) {
				...
				if (btn == "-") {
					...
					_43.css("float", "left").appendTo(tb).linkbutton(
							$.extend({}, btn, {
								plain : true
							}));
				}
				...
				for (var j = 0; j < _4a.length; j++) {
					...
					if (col.checkbox) {
						...
						if (col.field) {
							...
							col.boxWidth = $.boxModel ? (col.width - (_4c
									.outerWidth() - _4c.width())) : col.width;
	...
	function _4d(_4e) {
		...
		_52.find("tr[datagrid-row-index]").unbind(".datagrid").bind(
				"mouseenter.datagrid",
				function() {
					var _53 = $(this).attr("datagrid-row-index");
					_52.find("tr[datagrid-row-index=" + _53 + "]").addClass(
							"datagrid-row-over");
				}).bind(
				"mouseleave.datagrid",
				function() {
					var _54 = $(this).attr("datagrid-row-index");
					_52.find("tr[datagrid-row-index=" + _54 + "]").removeClass(
							"datagrid-row-over");
		...
		_52.find("div.datagrid-cell-check input[type=checkbox]").unbind(
				".datagrid").bind(
				"click.datagrid",
				function(e) {
					var _58 = $(this).parent().parent().parent().attr(
							"datagrid-row-index");
					if (_50.singleSelect) {
						_59(_4e);
						_5a(_4e, _58);
	...
	function _5c(_5d) {
		...
		_60.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind(
		...
		_60.find("div.datagrid-cell").unbind(".datagrid")
				.bind(
						"click.datagrid",
						function() {
							...
							_60.find("div.datagrid-cell").removeClass(
									"datagrid-sort-asc datagrid-sort-desc");
							$(this).addClass(c);
							if (_5f.onSortColumn) {
								_5f.onSortColumn.call(_5d, _5f.sortName,
										_5f.sortOrder);
							}
							if (_5f.remoteSort) {
								_139(_5d);
		...
		_60.find("input[type=checkbox]").unbind(".datagrid").bind(
		...
		_66.children("div.datagrid-body").unbind(".datagrid").bind(
				"scroll.datagrid",
				function() {
					_65.children("div.datagrid-body").scrollTop(
							$(this).scrollTop());
					_66.children("div.datagrid-header").scrollLeft(
							$(this).scrollLeft());
					_66.children("div.datagrid-footer").scrollLeft(
							$(this).scrollLeft());
				});
		_60.find("div.datagrid-cell").resizable(
				{
					...
					onStopResize : function(e) {
						...
						_6a.find("div.datagrid-header").scrollLeft(
								_6a.find("div.datagrid-body").scrollLeft());
						_64.children("div.datagrid-resize-proxy").css(
								"display", "none");
						_5f.onResizeColumn.call(_5d, _69, col.width);
					}
				});
		$("div.datagrid-view1 div.datagrid-header div.datagrid-cell", _5e)
				.resizable(
						{
							onStopResize : function(e) {
								...
								_6d.find("div.datagrid-header").scrollLeft(
										_6d.find("div.datagrid-body")
												.scrollLeft());
								_64.children("div.datagrid-resize-proxy").css(
										"display", "none");
	...
	function _6e(_6f) {
		...
		for (var i = 0; i < _74.length; i++) {
			...
			_72.find("td[field=" + col.field + "] div.datagrid-cell").width(
					col.boxWidth);
		}
		_31(_6f);
	}
	...
	function _95(_96, _97) {
		...
		if (!_98.remoteSort) {
			...
			if (opt) {
				...
				_97.rows.sort(function(r1, r2) {
					return _9c(r1[_98.sortName], r2[_98.sortName])
							* (_98.sortOrder == "asc" ? 1 : -1);
				});
			}
		}
		...
		_98.view.render.call(_98.view, _96, _9f.children("div.datagrid-body"),
				false);
		_98.view.render.call(_98.view, _96, _9e.children("div.datagrid-body")
				.children("div.datagrid-body-inner"), true);
		if (_98.showFooter) {
			_98.view.renderFooter.call(_98.view, _96, _9f
					.find("div.datagrid-footer-inner"), false);
			_98.view.renderFooter.call(_98.view, _96, _9e
	...
	function _a6(_a7) {
		...
		var _ad = [];
		$("div.datagrid-view2 div.datagrid-body tr.datagrid-row-selected", _a9)
				.each(function() {
	...
	function _b2(_b3) {
		...
		$("div.datagrid-cell-check input[type=checkbox]", _b9).attr("checked",
				true);
	...
	function _b0(_bb) {
		...
		$("div.datagrid-body tr.datagrid-row-selected", _bd).removeClass(
				"datagrid-row-selected");
		$("div.datagrid-body div.datagrid-cell-check input[type=checkbox]", _bd)
				.attr("checked", false);
		if (_bc.idField) {
	...
	function _5a(_c1, _c2) {
		...
		if (top <= 0) {
			...
			if (top + tr.outerHeight() > _c9.height() - 18) {
				_c9.scrollTop(_c9.scrollTop() + top + tr.outerHeight()
						- _c9.height() + 18);
			}
		}
		if (_c4.idField) {
	...
	function _5b(_d0, _d1) {
		...
		var ck = $("tr[datagrid-row-index=" + _d1
				+ "] div.datagrid-cell-check input[type=checkbox]", _d6);
	...
	function _df(_104, _105) {
		...
		var tr = $("div.datagrid-body tr[datagrid-row-index=" + _105 + "]",
				_106);
		tr
				.children("td")
				.each(
	...
	function _f0(_10c, _10d) {
		...
		var tr = $("div.datagrid-body tr[datagrid-row-index=" + _10d + "]",
				_10e);
		tr.children("td").each(function() {
			var cell = $(this).find("div.datagrid-editable");
			if (cell.length) {
	...
	function _e1(_110, _111) {
		...
		var tr = $("div.datagrid-body tr[datagrid-row-index=" + _111 + "]",
				_112);
		if (!tr.hasClass("datagrid-row-editing")) {
			return true;
		}
	...
	function _141(_142, _143) {
		...
		var tr = _144.find("div.datagrid-body tr[datagrid-row-index="
				+ _143.index + "]");
	...
	var _1ae = {
		...
		refreshRow : function(_1c4, _1c5) {
			...
			var _1c7 = opts.rowStyler ? opts.rowStyler.call(_1c4, _1c5,
					rows[_1c5]) : "";
			var tr = _1c6.find("div.datagrid-body tr[datagrid-row-index="
					+ _1c5 + "]");
			tr.attr("style", _1c7 || "");
			tr.children("td").each(
					function() {
						...
						if (col) {
							var _1c9 = col.styler ? col.styler(
									rows[_1c5][_1c8], rows[_1c5], _1c5) : "";
							td.attr("style", _1c9 || "");
							if (col.hidden) {
								td.hide();
							}
							if (col.formatter) {
								cell.html(col.formatter(rows[_1c5][_1c8],
										rows[_1c5], _1c5));
							} else {
		...
		onAfterRender : function(_1cb) {
			...
			if (opts.showFooter) {
				var _1cc = $(_1cb).datagrid("getPanel").find(
						"div.datagrid-footer");
				_1cc
						.find(
