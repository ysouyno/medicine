		...
		pp.panel($.extend({}, _1a,
				{
					...
					onBeforeExpand : function() {
						...
						if (_1c) {
							...
							_1d.find(".accordion-collapse").triggerHandler(
									"click");
						}
						var _1d = pp.panel("header");
						_1d.addClass("accordion-header-selected");
						_1d.find("div.accordion-collapse").removeClass(
								"accordion-expand");
					},
					onExpand : function() {
					...
					onBeforeCollapse : function() {
						...
						_1f.find("div.accordion-collapse").addClass(
								"accordion-expand");
					}
				}));
	...
	$.fn.accordion = function(_32, _33) {
		...
		return this.each(function() {
			...
			if (_34) {
				...
				_35 = $.extend({}, $.fn.accordion.defaults, $.fn.accordion
						.parseOptions(this), _32);
				var r = _13(this);
				$.data(this, "accordion", {
					options : _35,
