...
(function($) {
	function _1(_2) {
		...
		_4.find("a[icon=pagination-load]").unbind(".pagination")
				.bind(
						"click.pagination",
						function() {
							if (_3.onBeforeRefresh.call(_2, _3.pageNumber,
									_3.pageSize) != false) {
								_a(_2, _3.pageNumber);
								_3.onRefresh.call(_2, _3.pageNumber,
										_3.pageSize);
							}
						});
	...
	function _10(_11) {
		...
		num.parent().next().find("span").html(
				_12.afterPageText.replace(/{pages}/, _13));
