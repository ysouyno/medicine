...
(function($) {
	function _1(_2) {
		...
		;
		function _7(_b) {
			_b.addClass("menu").find(">div").each(
					function() {
						var _c = $(this);
	...
	$.fn.menu = function(_37, _38) {
		...
		return this.each(function() {
			...
			if (_39) {
				...
				_39 = $.data(this, "menu", {
					options : $.extend({}, $.fn.menu.defaults, _37)
				});
				_1(this);
			}
			$(this).css({
	...
	$.fn.menu.methods = {
		...
		setIcon : function(jq, _3b) {
			return jq.each(function() {
				...
				if (_3c.iconCls) {
					$(_3c.target).children("div.menu-icon").removeClass(
							_3c.iconCls).addClass(_3b.iconCls);
				} else {
					$("<div class=\"menu-icon\"></div>").addClass(_3b.iconCls)
							.appendTo(_3b.target);
				}
			});
		},
