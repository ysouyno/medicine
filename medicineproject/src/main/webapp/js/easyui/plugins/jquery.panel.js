...
(function($) {
	...
	;
	function _f(_10) {
		var _11 = $(_10).addClass("panel-body").wrap(
	...
	function _1e(_1f) {
		...
		if (_20.options.href && (!_20.isLoaded || !_20.options.cache)) {
			...
			_21.html($("<div class=\"panel-loading\"></div>").html(
					_20.options.loadingMessage));
			$.ajax({
	...
	function _2b(_35, _36) {
		...
		var _3a = _38.children("div.panel-header").find(
	...
	function _3b(_3c, _3d) {
		...
		var _41 = _3f.children("div.panel-header").find(
				"div.panel-tool-collapse");
	...
	function _50(_51) {
		...
		if (_52.border == true) {
			_53.children("div.panel-header").removeClass(
