						...
						view : {
							...
							makeDOMNodeMainBefore : function(c, a, b) {
								c
										.push(
												"<li ",
												b.isHidden ? "style='display:none;' "
														: "", "id='", b.tId,
												"' class='", l.className.LEVEL,
												b.level,
							...
							showNodes : function(c, a, b) {
								if (a && a.length != 0) {
									...
									for ( var j in e)
										a = e[j][c.data.key.children], d
												.setFirstNodeForShow(c, a), d
							...
							hideNodes : function(c, a, b) {
								if (a && a.length != 0) {
									...
									for ( var j in e)
										a = e[j][c.data.key.children], d
												.setFirstNodeForHide(c, a), d
												.setLastNodeForHide(c, a)
								}
							},
							setFirstNode : function(c, a) {
								var b = c.data.key.children, e = a[b].length;
								e > 0 && !a[b][0].isHidden ? a[b][0].isFirstNode = !0
										: e > 0
												&& d.setFirstNodeForHide(c,
														a[b])
							},
							setLastNode : function(c, a) {
								var b = c.data.key.children, e = a[b].length;
								e > 0 && !a[b][0].isHidden ? a[b][e - 1].isLastNode = !0
										: e > 0
												&& d
														.setLastNodeForHide(c,
																a[b])
							},
							...
							setFirstNodeForShow : function(c, a) {
								...
								for (e = 0, g = a.length; e < g; e++)
									if (b = a[e], !f && !b.isHidden
										...
										f = b;
										break
									} else if (!f && !b.isHidden
											&& !b.isFirstNode)
										b.isFirstNode = !0, f = b, d
												.setNodeLineIcos(c, b);
							...
							setLastNodeForShow : function(c, a) {
								...
								for (e = a.length - 1; e >= 0; e--)
									if (b = a[e], !g && !b.isHidden
										...
										g = b;
										break
									} else if (!g && !b.isHidden
											&& !b.isLastNode)
										b.isLastNode = !0, g = b, d
												.setNodeLineIcos(c, b);
