...
public class Vcom_3DES {
	...
	public String Vcom3DESChiper() {
		...
		// }
		/*
		 * String keyStr = null; try { BufferedReader in = new
		 * BufferedReader(new InputStreamReader(url.openStream())); while
		 * ((keyStr = in.readLine()) == null) { System.out.println("读取密钥失败！");
		 * return null; } in.close(); } catch (IOException e) {
		 * e.printStackTrace(); }
		 */
